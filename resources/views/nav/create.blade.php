    ...
    <div class="container-fluid">
      <div class="row justify-content-center">
        <div class="col-12 col-lg-10 col-xl-8">
          ...
          <!-- Form -->
          <form class="mb-4" action="{{route('store.nav')}}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-lg-12 form-group">
                          <label for="exampleInputEmail1">Seleccionar enlace</label>
                            <div class="input-group input-group-merge">
                              <input type="text" id="enlace_input" class="form-control form-control-prepended" placeholder="Nuevo enlace en el menú" name="enlace">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control" id="" placeholder="Titulo del menú" name="titulo">
                        ...
                        <div class="col-lg-6">
                          ...
                          <div class="input-group input-group-merge">
                            <input type="text" class="form-control form-control-prepended" placeholder="Icono" id="icono_input" name="icono">
                            <div class="input-group-prepend">
                              <div class="input-group-text" style="padding-right: 0px;padding:0px !important">
